...
private final class StubUserStore {
    ...
    private lazy var users: [JID: User] = [
        "alexandre@crisp.chat": User(
            ...
            fullName: "Alexandre",
            avatar: PreviewAsset.Avatars.alexandre.name,
        ...
        "antoine@crisp.chat": User(
            ...
            avatar: PreviewAsset.Avatars.antoine.name,
        ...
        "baptiste@crisp.chat": User(
            ...
            avatar: PreviewAsset.Avatars.baptiste.name,
            jobTitle: "CEO",
            company: "Crisp",
        ...
        "camille@crisp.chat": User(
            ...
            displayName: "Camille",
            fullName: "Camille LB",
            avatar: PreviewAsset.Avatars.camille.name,
        ...
        "constellation-health@crisp.chat": User(
            ...
            avatar: PreviewAsset.Avatars.constellationHealth.name,
            jobTitle: "Bot",
            company: "Crisp",
        ...
        "eliott@crisp.chat": User(
            ...
            avatar: PreviewAsset.Avatars.eliott.name,
            jobTitle: "Software Engineer",
            company: "Crisp",
        ...
        "julien@thefamily.com": User(
            ...
            avatar: PreviewAsset.Avatars.julien.name,
