...
public enum L10n {
  ...
  public enum Authentication {
    public enum AccountErrorAlert {
      ...
      ///
      /// This might mean that your credentials are invalid, or your account does not exist anymore
      /// on this server, or was blocked.
  ...
  public enum EditProfile {
    public enum Authentication {
      public enum MfaSection {
        public enum Footer {
          /// Multi-factor authentication adds an extra layer of security to your account, by asking
          /// for a temporary code generated by an app, upon login.
          ///
          /// In the event that you are unable to generate MFA tokens, you can still use your
          /// recovery phone number to login to your account.
          public static let label = L10n.tr(
            "Localizable",
      ...
      public enum PasswordSection {
        public enum Footer {
          /// Your password is what keeps your account secure. If you forget it, you can still
          /// recover it from your recovery email. **Make sure to keep it up-to-date.**
          public static let label = L10n.tr(
            "Localizable",
    ...
    public enum Encryption {
      ...
      public enum CurrentDeviceSection {
        public enum Footer {
          /// Your security key fingerprint is shown as a short hash, which you can use to compare
          /// with the one your contacts see on their end. **Both must match.**
          ///
      ...
      public enum OtherDevicesSection {
        public enum Footer {
          /// Removing a device will not sign out from account. It prevents all messages sent to you
          /// from being decrypted by this device, until you reconnect with this device.
          public static let label = L10n.tr(
            "Localizable",
    ...
    public enum Identity {
      public enum ContactSection {
        public enum Footer {
          /// **Your email address and phone number are public.** They are visible to all team
          /// members and contacts. They will not be available to other users.
          ///
          /// It is recommended that your email address and phone number each get verified, as it
          /// increases the level of trust of your profile. The process only takes a few seconds:
          /// you will receive a link to verify your contact details.
          public static let label = L10n.tr(
            "Localizable",
      ...
      public enum NameSection {
        public enum Footer {
          /// In order to show a verified badge on your profile, visible to other users, you should
          /// get your real identity verified (first name & last name). The process takes a few
          /// seconds: you will be asked to submit a government ID (ID card, passport or driving
          /// license). **Note that the verified status is optional.**
          ///
          /// Your data will be processed on an external service. This service does not keep any
          /// record of your ID after your verified status is confirmed.
          public static let label = L10n.tr(
            "Localizable",
    ...
    public enum Profile {
      ...
      public enum JobSection {
        public enum Footer {
          /// Your current organization and job title are shared with your team members and contacts
          /// to identify your position within your company.
          public static let label = L10n.tr(
            "Localizable",
      ...
      public enum LocationSection {
        public enum Footer {
          /// You can opt-in to automatic location updates based on your last used device location.
          /// It is handy if you travel a lot, and would like this to be auto-managed. Your current
          /// city and country will be shared, not your exact GPS location.
          ///
