...
/// It supports it, but we cannot put labels in the first column if they're not attached to a single
/// control.
/// To work around it, this `GroupBoxStyle` mimics the macOS form style.
///
/// - Note: This style might break some layout, accessibility and readability benefits of the system
/// style.
